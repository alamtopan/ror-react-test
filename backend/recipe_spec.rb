...
describe Recipe do
  before do
    ...
    Recipe.describe do
      ...
      recipe.ingredient 'Store-bought pancake mix'
      recipe.ingredient 'Water'
      recipe.step 'Mix the ingredients'
      recipe.step 'Cook them in a pan'
      recipe.add

      recipe = Recipe.new
      recipe.recipe 'Miso Soup'
      recipe.ingredient 'Tofu'
      recipe.ingredient 'White miso paste'
      recipe.step 'Mix miso paste into boiling water'
      recipe.step 'Add tofu and serve'
      recipe.add
    end
  end
